...
public class AcmLdapAuthenticationProvider extends LdapAuthenticationProvider implements ApplicationEventPublisherAware
{
    ...
    public Collection<? extends GrantedAuthority> loadAuthorities(DirContextOperations userData, String username, String password) {
        return this.loadUserAuthorities(userData, username, password);
    }
    ...
    public UserDetailsContextMapper getContextMapper() {
