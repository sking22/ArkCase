...
/**
 * @ngdoc controller
 * @name dashboard.ready-review-cases.controller:Dashboard.ReadyReviewCaseFilesController
 *
 * @description
 *
 * {@link /acm-standard-applications/arkcase/src/main/webapp/resources/modules/dashboard/controllers/components/ready-review-cases.client.controller.js modules/dashboard/controllers/components/ready-review-cases.client.controller.js}
 *
 * Loads cases in the "Ready for Review" widget.
 */
angular.module('dashboard.ready-review-cases').controller('Dashboard.ReadyReviewCaseFilesController', [
 ...
 function($scope, $translate, config, Authentication, DashboardService, TaskAlertsService, UtilDateService,
    ...
    ConfigService.getComponentConfig("dashboard", "readyReviewCases").then(function(config) {
        vm.config = config;
     ...
     * @ngdoc method
     * @name openViewer
     * @methodOf dashboard.ready-review-cases.controller:Dashboard.ReadyReviewCaseFilesController
     *
     *
     * @description
