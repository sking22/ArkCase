 ...
 * @description
 *
 * {@link /acm-standard-applications/arkcase/src/main/webapp/resources/modules/dashboard/controllers/components/audit-report-widget.client.controller.js modules/dashboard/controllers/components/audit-report-widget.client.controller.js}
 *
...
angular.module('dashboard.websites-widget', ['adf.provider']).config(function (ArkCaseDashboardProvider) {
    ...
    ['$scope', '$window', '$modal', '$translate', 'config', 'Authentication', 'Dashboard.DashboardService', 'UtilService', 'Helper.UiGridService', 'ConfigService', function ($scope, $window, $modal, $translate, config, Authentication, DashboardService, Util, HelperUiGridService, ConfigService) {
        ...
        $scope.websiteCompare = function(a, b) {
            var uppercaseNameA = ((a != null) && (a != undefined) && (a.name != null) && (a.name != undefined))? a.name.toUpperCase(): "";
            var uppercaseNameB = ((b != null) && (b != undefined) && (b.name != null) && (b.name != undefined))? b.name.toUpperCase(): "";
            if(uppercaseNameA > uppercaseNameB)
                return 1;
            if(uppercaseNameB > uppercaseNameA)
                return -1;
            return 0;
        }
        ...
        function loadSites(userId) {
            DashboardService.queryUserWebsites({
                ...
                if (data && data[0]) {
                    ...
                    jsonObj.sites.sort($scope.websiteCompare);
                    vm.sitesList = jsonObj.sites;
                    vm.gridOptions.totalItems = vm.sitesList.length;
                    vm.gridOptions.data = angular.copy(vm.sitesList);
                } else {
