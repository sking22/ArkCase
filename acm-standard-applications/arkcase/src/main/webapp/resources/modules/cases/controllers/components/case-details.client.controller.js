    ...
    [
        ...
        function($scope, $modal, $stateParams, $translate, Util, ConfigService, CaseInfoService, CaseLookupService, MessageService, HelperObjectBrowserService, MentionsService, ObjectService, SuggestedObjectsService, UserInfoService, ObjectLookupService, moment) {
            ...
            $scope.saveAll = function() {
                if($scope.objectInfo.acmObjectOriginator.person.defaultIdentification.idConvictionDate === null
                    || $scope.objectInfo.acmObjectOriginator.person.defaultIdentification.idConvictionDate === ''
                    || $scope.objectInfo.acmObjectOriginator.person.defaultIdentification.idConvictionDate === undefined){
